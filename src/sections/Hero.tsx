...
const Hero = () => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      animate={{
        backgroundPositionX: starrsBg.width,
      }}
      transition={{
        repeat: Infinity,
        ease: "linear",
      ...
      style={{
        backgroundImage: `url(${starrsBg.src})`,
        backgroundPositionY,
      }}
    >
      <div className="absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_78%,transparent)]"></div>
      <div
        className="absolute h-64 w-64 md:h-96 md:w-96 bg-purple-500 rounded-full border border-white/20 top-1/2
      left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_.3%,white,rgb(184,148,255)_37.7%,rgb(24,0,66))] 
      ...
      <motion.div
        ...
        className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] rounded-full border border-white opacity-20 top-1/2 left-1/2
      ...
      <div className="container mx-auto relative mt-10">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          ...
          <span className="text-white"> Training</span> across various fields,
